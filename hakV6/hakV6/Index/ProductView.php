    ...
    if(!$con)
      ...
      if(isset($_POST['submit'])) {
        ...
        if(isset($_SESSION['auction'])){
          ...
          header("location: ..\Index\checkout\checkout.php");
        } else {
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 mt-6 lg:mt-0">
        ...
        <p class="leading-relaxed"><?php echo $rows['Description'];?> </p>
         ...
         <div class="row">
            ...
            <div class="col-6">
              <button name="submit2" type="submit" value="ProductView.php?proid=<?php echo $rows['Product_ID'];?>" style="margin-top:10px;" class="flex ml-auto bg-green-500 text-white  border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Add to cart</button>
            </div>
         </div> 
         </form>       
