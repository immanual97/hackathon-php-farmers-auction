<?php
    ...
    if(!$con)
      ...
      if(isset($_SESSION['a']))
      {
		  ...
		  $sql2="SELECT auctiondetails.*,product.* FROM auctiondetails,product WHERE auctiondetails.P_ID=$proid AND auctiondetails.P_ID=product.Product_ID";
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div class="lg:w-1/2 w-full lg:pl-10 mt-6 lg:mt-0">
		...
		<p style="text-transform: uppercase;font-weight: bold;text-align:left;"> Time Left:</p>
			<p style="text-align:left;" >
							...
							<script language="JavaScript" src="countdown.js"></script>
								...
								<h2 class="text-gray-900 text-3xl title-font font-medium mb-1">Current Price: <?php echo $rows1['Bid']; }?></h2>
